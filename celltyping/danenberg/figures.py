...
CONFIG_PATH = "./danenberg/dberg_config.yaml"
config = load_config(CONFIG_PATH)

base_path = config["base_path"]
crossval_dir = os.path.join(base_path, "crossval")
csv_output_dir = "./danenberg/csv"
...
DISPLAY_MAP = {
    ...
    "B Cell": "B Cell",
    "ER-Negative Epithelial Cell": "ER-",
    "ER-Positive Epithelial Cell": "ER+",
    "Myeloid": "Myeloid",
...
if __name__ == "__main__":
    ...
    for cfg in FIGURE_CONFIG:
        ...
        generate_metric_bar_figure(
            ...
            metric=metric,
            save_path=f"./danenberg/figures/{cfg['name']}",
            figsize=(10, 6.5),
            ylabel=ylabel,
            rotation=65,
        )
